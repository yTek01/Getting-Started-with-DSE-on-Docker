...
```
docker run -e DS_LICENSE=accept -p 8888:8888 --name my-opscenter -d datastax/dse-opscenter:6.8.15
```
...
```
docker run -e DS_LICENSE=accept --link datastax_server --name my-studio -p 9091:9091 -d datastax/dse-studio:6.8.15
```
